            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="form-group row">
                            <label for="category-description" class="col-sm-3 col-form-label">Long Description</label>
                            <div class="col-sm-9">
                                <textarea class="form-control" name="long-description"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="category-description" class="col-sm-3 col-form-label">Blog Image</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="radio" name="pb_status" id="publication-status" value="1"> Published
                                <input type="radio" name="pb_status" id="publication-status" value="2"> Unpublished
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-12">
